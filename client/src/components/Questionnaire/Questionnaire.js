...
export default function Questionnaire() {
  ...
  const questionList = [
    ...
    {
      id: 9,
      question: "Do you suffer from a chronical disease?",
      options: ["Yes", "No"],
    },
    {
      id: 10,
    ...
    {
      id: 15,
      question: "For women only: Have you been pregnant in the last 6 months?",
      options: ["Yes", "No"],
    },
    {
      id: 16,
      ...
      options: [
        ...
        "Less than one month, more than ten days ago",
