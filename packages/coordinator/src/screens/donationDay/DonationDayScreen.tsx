...
function DayHeader(props: {
  ...
  const appointmentsCount = props.showOnlyAvailableAppointments?
    props.allAppointments.length-bookedAppointmentsCount : props.allAppointments.length;
  return (
    <>
      <div className={styles.donationDate}>
        ...
        <div className={styles.data}>
          ...
          {!props.showOnlyAvailableAppointments && <span className={styles.dataDivider}>|</span>}
          {!props.showOnlyAvailableAppointments && <span>{bookedAppointmentsCount} רשומים</span>}
        </div>
      </div>
