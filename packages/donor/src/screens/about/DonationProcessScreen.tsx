  ...
  return (
    <ZMScreen hasBackButton title="תהליך התרומה">
      ...
      <div className={styles.textContainer}>
        ...
        מנת התרומה טובה רק לחמישה ימים ולכן יש צורך בתרומות רבות באופן שוטף. מה
        שונה תרומת תם מתרומת טרומבוציטים?
        <div className={styles.subtitle}>
          מה שונה תרומת תם מתרומת טרומבוציטים?
        </div>
