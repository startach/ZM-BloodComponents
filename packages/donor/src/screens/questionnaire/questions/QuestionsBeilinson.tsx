  ...
  return (
    <>
      ...
      <Popup
        ...
        content={
          "אך לצערנו נראה שאי אפשר לתרום טרומבוציטים במצב זה. לבירור נוסף ניתן ליצור קשר עם מיכל, מתאמת התרומות בבילינסון, בטלפון 03−9376052 או עם רכז בנק הדם בהודעת וואטסאפ"
        }
