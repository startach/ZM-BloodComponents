...
export default function QuestionsTelHashomer({
  ...
  return (
    <>
      <Question
        name={Hospital.TEL_HASHOMER + "_was_pregnant"}
        value={wasPregnant}
      ...
      />
      <Question
        name={Hospital.TEL_HASHOMER + "_is_right_age"}
        value={isRightAge}
      ...
      />
      <Question
        name={Hospital.TEL_HASHOMER + "_is_weight_valid"}
        value={isWeightValid}
      ...
      />
      <Question
        name={Hospital.TEL_HASHOMER + "_is_surgery_valid"}
      ...
      />
      <Question
        name={Hospital.TEL_HASHOMER + "_is_tatoo_valid"}
        value={isTattooValid}
