...
export default function QuestionsTelHashomer({
  ...
  return (
    <>
      <Question
        analytics={{ analyticsName: Hospital.TEL_HASHOMER + "_was_pregnant" }}
        value={wasPregnant}
      ...
      />
      <Question
        analytics={{ analyticsName: Hospital.TEL_HASHOMER + "_is_right_age" }}
        value={isRightAge}
      ...
      <Question
        analytics={{
          analyticsName: Hospital.TEL_HASHOMER + "_is_weight_valid",
        }}
        value={isWeightValid}
      ...
      <Question
        analytics={{
          analyticsName: Hospital.TEL_HASHOMER + "_is_surgery_valid",
        }}
      ...
      />
      <Question
        analytics={{ analyticsName: Hospital.TEL_HASHOMER + "_is_tatoo_valid" }}
        value={isTattooValid}
